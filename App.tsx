...
const App: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {module === Module.SKETCHPAD && <Sketchpad items={data.sketchpad || []} addItem={addSketchItem} deleteItem={deleteSketchItem} updateItem={updateSketchItem} config={visibleConfig} />}
