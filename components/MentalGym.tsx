  ...
  return (
    <div className="flex flex-col h-full max-w-4xl mx-auto p-4 md:p-8 space-y-6">
       <header className="flex justify-between items-end shrink-0">
        <div>
            <h1 className="text-2xl md:text-3xl font-light text-slate-800 dark:text-slate-200 tracking-tight">Нейро <span className="text-violet-500 text-base md:text-lg">/ Тренировка</span></h1>
            <p className="text-slate-500 dark:text-slate-400 mt-2 text-sm">Твой тренажер памяти. Интервальные повторения важных инсайтов.</p>
        </div>
      </header>
        ...
        {flashcards.length > 0 && flashcards[currentCardIndex] ? (
            ...
            <div className="py-10">
                <EmptyState 
                    icon={Dumbbell} 
                    title="Спортзал пуст" 
                    description="Создайте карточки навыков в «Разборе» после анализа ИИ, чтобы начать тренировку." 
                    color="violet"
                />
            </div>
        )}
