  ...
  return (
    <div className="h-full overflow-y-auto custom-scrollbar-light p-4 md:p-8 relative">
      <header className="mb-6 flex justify-between items-end">
        <div>
          <h1 className="text-2xl md:text-3xl font-light text-slate-800 dark:text-slate-200 tracking-tight">Ритм <span className="text-orange-500 text-lg">/ Привычки</span></h1>
          <p className="text-slate-500 dark:text-slate-400 mt-2 text-sm">Система регулярных действий. Дисциплина без стресса.</p>
        </div>
        {!isFormOpen && (
            <button 
                onClick={openNewForm} 
