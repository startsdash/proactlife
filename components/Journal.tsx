                        ...
                        <div key={entry.id} className="relative pl-20 md:pl-28 group">
                            ...
                            {linkedTask && !isEditing && (
                                <button 
                                    ...
                                    className="block mt-4 w-full bg-slate-50 dark:bg-slate-800/50 hover:bg-white dark:hover:bg-slate-800 transition-all rounded-2xl border border-slate-100 dark:border-slate-700/50 shadow-sm p-4 text-left group/link relative overflow-hidden"
                                >
                                    ...
                                    <h4 className="text-sm font-medium text-slate-800 dark:text-slate-200 line-clamp-1 font-sans">{linkedTask.content}</h4>
                                </button>
                            )}
                ...
                <div className="space-y-4">
                    ...
                    {selectedLinkedTask && (
                        ...
                        >
                            ...
                            <h4 className="text-sm font-medium text-slate-800 dark:text-slate-200 line-clamp-1 font-sans">{selectedLinkedTask.content}</h4>
                        </button>
                    )}
