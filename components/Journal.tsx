        ...
        >
             ...
             >
                ...
                <div className="relative z-10 w-full px-4 md:px-8 pt-4 pb-2">
                    <div className="max-w-3xl mx-auto w-full flex md:gap-4">
                        {/* SPACER for Desktop Alignment with Creation Block Buttons */}
             ...
             <div className="w-full px-4 md:px-8 mb-10 z-30 relative">
                <div className="max-w-3xl mx-auto w-full flex flex-col md:flex-row md:gap-4 items-start">
                    
                    {/* TOOLS (Moved from Header) */}
                    <div className="flex md:flex-col gap-2 shrink-0 mb-4 md:mb-0 w-full md:w-10 justify-end md:justify-start order-first">
                        {hasMentorTool && (
                            <>
                                <Tooltip content={isAnalyzing ? "Остановить генерацию" : "Наставник (ИИ)"} side="right" disabled={isAnalyzing}>
                                    <button 
                                        onClick={handleAnalyzePath} 
                                        disabled={displayedEntries.length === 0} 
                                        className={`flex items-center justify-center w-10 h-10 rounded-xl border transition-all shadow-sm ${
                                ...
                                <Tooltip content="История диалогов" side="right">
                                    <button onClick={() => setShowHistory(true)} className="flex items-center justify-center w-10 h-10 rounded-xl border transition-all bg-white/80 dark:bg-slate-800/80 border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-400 hover:border-indigo-200 dark:hover:border-indigo-800 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 shadow-sm">
                    ...
                    <div className="flex-1 w-full" ref={creationRef}>
                        {!isCreationExpanded ? (
                            <div 
