  ...
  return (
    <div className="flex flex-col h-full overflow-hidden bg-[#f8fafc]">
        ...
        <div className="flex flex-1 overflow-hidden p-4 md:p-8 gap-6 relative">
                        ...
                        <div key={note.id} onClick={() => handleSelectNote(note)} className={`p-4 rounded-xl border cursor-pointer transition-all active:scale-[0.98] group relative ${selectedNoteId === note.id ? 'bg-amber-50 border-amber-300 shadow-sm' : 'bg-white border-slate-200 hover:border-amber-200 shadow-sm'}`}>
                            ...
                            <div className="flex justify-between items-center mt-2 border-t border-slate-50 pt-2">
                                ...
                                <button 
                                    ...
                                    className="p-1.5 text-slate-400 hover:text-red-600 bg-white hover:bg-red-50 rounded-lg transition-colors border border-slate-100 hover:border-red-100 shadow-sm"
                                    title="Удалить"
                                >
                                    <Trash2 size={14} />
                                </button>
            ...
            `}>
                <div className="md:hidden mb-4 flex items-center justify-between text-slate-500 shrink-0">
                     <div className="flex items-center gap-2" onClick={handleBackToList}>
                        <button className="p-2 bg-white border border-slate-200 rounded-full shadow-sm"><ArrowLeft size={20} /></button>
                        ...
                        {isAnalyzing ? (
                            ...
                            <div className="flex flex-col gap-8 animate-in fade-in slide-in-from-bottom-4 duration-500 mt-6 md:mt-0">
                                ...
                                <div className="bg-slate-50 rounded-xl p-5 border-l-4 border-slate-800">
                                    ...
                                    <div className="text-slate-700 italic leading-relaxed text-base">
